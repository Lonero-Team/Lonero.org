...
function FormEvent(e) {
    e.preventDefault();
    var t = e.target,
        n = new SerializeForm(t).call(),
        a = new ElementOptions(t).call();
...
function Loader() {
    var e = (new ParsePage).call(),
        ...
        a = function (e) {
            ...
            n.innerHTML = t(window.sheetsuReplacedElements.length - 1), e.innerHTML = "", e.appendChild(n)
        },
        r = function (e) {
        ...
        s = function () {
            ...
            return e.textContent = "@-webkit-keyframes placeHolderShimmer{0%{background-position: -800px 0}100%{background-position: 800px 0}};", e
        };
    return {
        show: function () {
            document.body.appendChild(s()), n();
            for (var t = e.length - 1; t >= 0; t--) r(e[t]) || "FORM" == e[t].tagName || a(e[t])
        },
        hide: function () {
            n();
...
function RequestSpreadsheet(e) {
    ...
    var t = function (e) {
            var t = a(e.slug),
                n = "";
            return delete e.slug, e.sheet && (n += s(e)), e.search ? n += r(e) : e.column && e["column-value"] ? n += i(e) : n += "?" + o(e), t + n
        },
        n = function (e) {
            var t = a(e.slug);
            return e.sheet && (t += s(e)), t
        },
        a = function (e) {
            return e.startsWith("https://sheetsu.com/apis/v1.0") ? e : "https://sheetsu.com/apis/v1.0oh/" + e
        },
        r = function (e) {
            var t = [],
        ...
        i = function (e) {
            return "/" + e.column + "/" + e["column-value"] + "?" + o(e)
        },
        s = function (e) {
